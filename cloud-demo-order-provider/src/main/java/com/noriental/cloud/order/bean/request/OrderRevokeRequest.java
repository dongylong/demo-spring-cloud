...
import com.noriental.cloud.order.bean.enumerate.RevokeLogStatusEnum;
...
public class OrderRevokeRequest extends BaseRequest {
     ...
     */
    @NotNull
    private RevokeLogStatusEnum revokeLogStatusEnum;
    /**
     * 平台同意来源（returnsLogStatus是3平台同意申请时必传) 1：商家同意后平台同意， 2：商家不同意后平台同意 3：三方协调后平台同意
     */
    private String platformPassForm;
    /**
     * 平台取消售后来源（returnsLogStatus是5 平台发起的取消售后) 1：三方协商后取消， 2：平台验货后取消
     */
    private String platformCancelForm;
    /**
     * 备注
     */
    ...
    /**
     * 快递公司（仅消费者提交快递凭证和商家补填物流信息时的时候使用）
     */
    private String logisticsComName;
    /**
     * 快递公司编码（仅商家补填物流信息时候使用）
     */
    private String logisticsComCode;
    /**
     * 快递单号（仅消费者提交快递凭证和商家补填物流信息时的时候使用）
     */
    ...
    @NotNull
    public RevokeLogStatusEnum getRevokeLogStatusEnum() {
        return revokeLogStatusEnum;
    }

    public void setRevokeLogStatusEnum(@NotNull RevokeLogStatusEnum revokeLogStatusEnum) {
        this.revokeLogStatusEnum = revokeLogStatusEnum;
    }

    public String getPlatformPassForm() {
        return platformPassForm;
    }

    public void setPlatformPassForm(String platformPassForm) {
        this.platformPassForm = platformPassForm;
    }

    public String getPlatformCancelForm() {
        return platformCancelForm;
    }

    public void setPlatformCancelForm(String platformCancelForm) {
        this.platformCancelForm = platformCancelForm;
    }
